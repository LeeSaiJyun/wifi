<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"/home/wwwroot/wifi.8a6.cn/public/../application/admin/view/general/profile/index.html";i:1515034408;s:78:"/home/wwwroot/wifi.8a6.cn/public/../application/admin/view/layout/default.html";i:1514425103;s:75:"/home/wwwroot/wifi.8a6.cn/public/../application/admin/view/common/meta.html";i:1514425103;s:77:"/home/wwwroot/wifi.8a6.cn/public/../application/admin/view/common/script.html";i:1514425103;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="panel-body">
                ...
                <form id="update-form" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.profile/update'); ?>">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <p class="text-muted text-center"><?php echo $admin['phone']; ?></p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="row[phone]" value="<?php echo $admin['phone']; ?>" data-rule="required;phone" />
                        </div>
                        <div class="form-group">
